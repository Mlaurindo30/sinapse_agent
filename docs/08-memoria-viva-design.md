...
> **Versão**: 2.13 (F4.1 decision_promoter LIVE — frontal/decisoes auto-preenchido; gemini-cli no workload real OK)
> **Data**: 2026-06-17
...
*Documento vivo. Versão 2.13 (F4.1 decision_promoter `66fee55` LIVE; dream real via gemini-cli ok — 24 neurônios/7 projetos/ciclo). Próxima: F4.2 project_synthesizer.*
