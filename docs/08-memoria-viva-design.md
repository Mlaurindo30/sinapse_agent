...
> **Versão**: 2.6 (modelo anatômico — Fase 3 desenhada task-a-task + contrato §14 + Fase 1 LIVE)
> **Data**: 2026-06-17
...
*Documento vivo. Versão 2.6 (Fase 3 desenhada com trechos de implementação F3.1-F3.4 + §14 + Fase 1 LIVE). Próxima revisão: após P1 (timers no install_services) + go-live Fase 2.*
